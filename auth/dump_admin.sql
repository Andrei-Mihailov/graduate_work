...
--
-- Name: groups; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.groups OWNER TO app;

--
-- Name: groups_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Name: promo_codes; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.promo_codes OWNER TO app;

--
-- Name: promo_codes_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Name: purchases; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.purchases OWNER TO app;

--
-- Name: purchases_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Name: tariffs; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.tariffs OWNER TO app;

--
-- Name: tariffs_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
25	Can add Группа	7	add_group
26	Can change Группа	7	change_group
27	Can delete Группа	7	delete_group
28	Can view Группа	7	view_group
...
33	Can add Промокод	9	add_promocode
34	Can change Промокод	9	change_promocode
35	Can delete Промокод	9	delete_promocode
36	Can view Промокод	9	view_promocode
...
41	Can add Покупка	11	add_purchase
42	Can change Покупка	11	change_purchase
43	Can delete Покупка	11	delete_purchase
44	Can view Покупка	11	view_purchase
\.
...
7	users	group
8	users	user
9	promocodes	promocode
10	promocodes	tariff
11	promocodes	purchase
\.
...
1	contenttypes	0001_initial	2024-07-20 21:36:08.778596+00
2	auth	0001_initial	2024-07-20 21:36:09.827176+00
3	admin	0001_initial	2024-07-20 21:36:10.155606+00
4	admin	0002_logentry_remove_auto_add	2024-07-20 21:36:10.222441+00
5	admin	0003_logentry_add_action_flag_choices	2024-07-20 21:36:10.270743+00
6	contenttypes	0002_remove_content_type_name	2024-07-20 21:36:10.368743+00
7	auth	0002_alter_permission_name_max_length	2024-07-20 21:36:10.486117+00
8	auth	0003_alter_user_email_max_length	2024-07-20 21:36:10.54761+00
9	auth	0004_alter_user_username_opts	2024-07-20 21:36:10.61006+00
10	auth	0005_alter_user_last_login_null	2024-07-20 21:36:10.661376+00
11	auth	0006_require_contenttypes_0002	2024-07-20 21:36:10.687391+00
12	auth	0007_alter_validators_add_error_messages	2024-07-20 21:36:10.752228+00
13	auth	0008_alter_user_username_max_length	2024-07-20 21:36:10.829835+00
14	auth	0009_alter_user_last_name_max_length	2024-07-20 21:36:10.884411+00
15	auth	0010_alter_group_name_max_length	2024-07-20 21:36:11.020556+00
16	auth	0011_update_proxy_permissions	2024-07-20 21:36:11.094544+00
17	auth	0012_alter_user_first_name_max_length	2024-07-20 21:36:11.159543+00
18	users	0001_initial	2024-07-20 21:36:11.611427+00
19	promocodes	0001_initial	2024-07-20 21:36:12.272133+00
20	sessions	0001_initial	2024-07-20 21:36:12.483712+00
\.
...
--
-- Data for Name: groups; Type: TABLE DATA; Schema: public; Owner: app
--
...
--
-- Data for Name: promo_codes; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.promo_codes (id, code, discount, is_active, creation_date) FROM stdin;
\.


--
-- Data for Name: purchases; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.purchases (id, total_price, purchase_date, promo_code_id, tariff_id, user_id) FROM stdin;
\.


--
-- Data for Name: tariffs; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.tariffs (id, name, price, description) FROM stdin;
\.
...
COPY public."user" (id, password, last_login, username, group_id) FROM stdin;
\.
...
--
-- Name: groups_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--
...
--
-- Name: promo_codes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--
...
--
-- Name: purchases_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--
...
--
-- Name: tariffs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--
...
--
-- Name: groups groups_name_key; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: groups groups_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: promo_codes promo_codes_code_key; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: promo_codes promo_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: purchases purchases_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: tariffs tariffs_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: user user_username_key; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: groups_name_46b2c599_like; Type: INDEX; Schema: public; Owner: app
--
...
--
-- Name: promo_codes_code_ca215ca7_like; Type: INDEX; Schema: public; Owner: app
--
...
--
-- Name: purchases_promo_code_id_949eea9a; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX purchases_promo_code_id_949eea9a ON public.purchases USING btree (promo_code_id);


--
-- Name: purchases_tariff_id_1ef56cae; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX purchases_tariff_id_1ef56cae ON public.purchases USING btree (tariff_id);


--
-- Name: purchases_user_id_5638b5ea; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX purchases_user_id_5638b5ea ON public.purchases USING btree (user_id);


--
-- Name: user_group_id_50ce08ac; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX user_group_id_50ce08ac ON public."user" USING btree (group_id);


--
-- Name: user_username_cf016618_like; Type: INDEX; Schema: public; Owner: app
--
...
--
-- Name: purchases purchases_promo_code_id_949eea9a_fk_promo_codes_id; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.purchases
    ADD CONSTRAINT purchases_promo_code_id_949eea9a_fk_promo_codes_id FOREIGN KEY (promo_code_id) REFERENCES public.promo_codes(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: purchases purchases_tariff_id_1ef56cae_fk_tariffs_id; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.purchases
    ADD CONSTRAINT purchases_tariff_id_1ef56cae_fk_tariffs_id FOREIGN KEY (tariff_id) REFERENCES public.tariffs(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: purchases purchases_user_id_5638b5ea_fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.purchases
    ADD CONSTRAINT purchases_user_id_5638b5ea_fk_user_id FOREIGN KEY (user_id) REFERENCES public."user"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: user user_group_id_50ce08ac_fk_groups_id; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public."user"
    ADD CONSTRAINT user_group_id_50ce08ac_fk_groups_id FOREIGN KEY (group_id) REFERENCES public.groups(id) DEFERRABLE INITIALLY DEFERRED;
