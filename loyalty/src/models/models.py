from sqlalchemy import Column, Integer, String, Date, Boolean, DECIMAL, ForeignKey, TIMESTAMP
...
class Promocode(Base):
    ...
    usage_limit = Column(Integer)  # ограничение на количество использований (NULL для неограниченного)
...
Promocode.usages = relationship("PromoUsage", order_by=PromoUsage.id, back_populates="promocode")
